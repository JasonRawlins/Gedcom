...
{
    public static readonly string InputFilesDirectory = @"C:\temp\GedcomNet\InputFiles";
    public static readonly string OutputFilesDirectory = @"C:\temp\GedcomNet\OutputFiles";
