...
public class RecordStructureBase
{
    ...
    // The method name "_" finds a child record value by tag name (Come up with a better name). It's used so often that I shortened it to make the code easier to read.
